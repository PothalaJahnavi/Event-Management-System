...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      const result = await firebase.AdminEvents();
  ...
  return (
    <div>
      ...
      <div>
        <h6 className="text-center">Events Created So Far</h6>
        <div className="m-4 d-flex flex-wrap gap-4 justify-content-center">
          {events?.map((event) => {
            return (
              <div class="card" style={{width:'350px'}}>
                ...
                <div class="container card-body ">
                  ...
                  <Link to={`/edit-event/${event.id}`} class="btn btn-primary" style={{width:"100%"}}>
                    Edit
                  </Link>
                </div>
              </div>
